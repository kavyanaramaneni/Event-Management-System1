      ...
      <div className="container md:w-10/12">
        <div className="heading">
          ...
          <span className="heading-blue">
            SAMYAK<span className="heading-white">?</span>
          </span>
        </div>
        <div className="content content-responsive">
          SAMYAK is the annual tech fest organized by our college, where
        ...
        <div className="about-section">
          <div className="about-text">
            ...
            <p className="p-responsive">
              SAMYAK is not just an event, it's an experience. From coding
              challenges to robotic competitions, from technical talks to
              hands-on workshops, SAMYAK offers something for everyone. Join us
          ...
          <div className="about-image ">
            <img src={logo} alt="SAMYAK Tech Fest" />
          </div>
        </div>
        <div className="explore overflow-hidden ">
          ...
          <div className="explore-text explore-text-2 aimate-text-2">
            <span className="text-[#9000FF]">SAMYAK TECH FEST</span>{" "}
            <span className="text-white">SAMYAK TECH FEST</span>{" "}
            <span className="text-[#9000FF]">SAMYAK TECH FEST</span>{" "}
            <span className="text-white">SAMYAK TECH FEST</span>{" "}
            <span className="text-[#9000FF]">SAMYAK TECH FEST</span>{" "}
            <span className="text-white">SAMYAK TECH FEST</span>{" "}
